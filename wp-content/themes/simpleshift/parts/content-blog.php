<?php
$simpleshift_blog_sidebar_position = simpleshift_get_option('simpleshift_blog_sidebar_position');
            ...
            while (have_posts()) {
                ...
                <div <?php post_class('frontpage-post'); ?> data-sr="scale up 25%">
                    ...
                    <div class="frontpage-post-content">
                        ...
                        <p class="meta">
                        <?php the_time( 'M' ); ?>. <?php the_time( 'j' ); ?>, <?php the_time( 'Y' ); ?> <?php _e('by', 'simpleshift'); ?> <?php the_author_posts_link(); ?></p>
                        <?php the_excerpt(); ?>
                    </div>
                </div>
                <?php
